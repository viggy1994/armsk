...
public class CheckFileManagerActivity extends Activity {
	...
	//private Resources res; //may use res.getText() to get strings. 
    ...
    final public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.checkfile);
		    	...
		    	switch(resultCode) {
			    	case Activity.RESULT_OK:
			    		...
			    		if (!file.exists()) {
			    			...
			    			Toast.makeText(this, "File doesn't exist!", TOAST_TIMEOUT).show();
			    			selectFile();
			    		} else {
			    			String fileName = data.getDataString();
			    			if(!fileName.endsWith(".jpg")) {
			    				Toast.makeText(this, "Wrong file format!", TOAST_TIMEOUT).show();
			    				selectFile();
			    			} else {
				    			//Start make-marker process (feature & descriptor extraction)
    ...
    private void selectFile() {    	
        ...
        intent.setData(Uri.parse("file:///sdcard/ARmsk/Markers"));
        intent.putExtra("org.openintents.extra.TITLE", "Select a marker file:");
    ...
    private boolean installPickFileIntent() {
        ...
        if (!(packageManager
        	...
        	infoText.setText("Android market is not available, you need install to OI File manager manually.");
        	return false;
        } else {
    ...
    protected Dialog onCreateDialog(int id) {
    	...
    	switch(id){
    		case INSTALL_INTENT_DIALOG:
	            ...
	            alertDialog.setMessage("You need to install the OI File Manager in order to use this application.");
